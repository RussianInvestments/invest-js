...
export const GetBondEventsResponse: MessageFns<GetBondEventsResponse> = {
  ...
  fromPartial(object: DeepPartial<GetBondEventsResponse>): GetBondEventsResponse {
    const message = createBaseGetBondEventsResponse();
    message.events =
      object.events?.map((e) => GetBondEventsResponse_BondEvent.fromPartial(e)) || [];
    return message;
  },
};
...
export const GetBondEventsResponse_BondEvent: MessageFns<GetBondEventsResponse_BondEvent> = {
  ...
  fromPartial(
    object: DeepPartial<GetBondEventsResponse_BondEvent>
    ...
    message.eventTotalVol =
      object.eventTotalVol !== undefined && object.eventTotalVol !== null
    ...
    message.moneyFlowVal =
      object.moneyFlowVal !== undefined && object.moneyFlowVal !== null
    ...
    message.couponInterestRate =
      object.couponInterestRate !== undefined && object.couponInterestRate !== null
  ...
  fromPartial(object: DeepPartial<Option>): Option {
    ...
    message.strikePrice =
      object.strikePrice !== undefined && object.strikePrice !== null
        ...
        : undefined;
    message.dlongClient =
      object.dlongClient !== undefined && object.dlongClient !== null
        ? Quotation.fromPartial(object.dlongClient)
        : undefined;
    message.dshortClient =
      object.dshortClient !== undefined && object.dshortClient !== null
...
export const GetFavoritesResponse: MessageFns<GetFavoritesResponse> = {
  ...
  fromPartial(object: DeepPartial<GetFavoritesResponse>): GetFavoritesResponse {
    ...
    message.favoriteInstruments =
      object.favoriteInstruments?.map((e) => FavoriteInstrument.fromPartial(e)) || [];
    return message;
  },
};
...
export const EditFavoritesRequest: MessageFns<EditFavoritesRequest> = {
  ...
  fromPartial(object: DeepPartial<EditFavoritesRequest>): EditFavoritesRequest {
    const message = createBaseEditFavoritesRequest();
    message.instruments =
      object.instruments?.map((e) => EditFavoritesRequestInstrument.fromPartial(e)) || [];
...
export const GetBrandsRequest: MessageFns<GetBrandsRequest> = {
  ...
  fromPartial(object: DeepPartial<GetBrandsRequest>): GetBrandsRequest {
    const message = createBaseGetBrandsRequest();
    message.paging =
      object.paging !== undefined && object.paging !== null
...
export const GetAssetFundamentalsResponse: MessageFns<GetAssetFundamentalsResponse> = {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.fundamentals.push(
            GetAssetFundamentalsResponse_StatisticResponse.decode(reader, reader.uint32())
          );
          continue;
        }
      }
  ...
  toJSON(message: GetAssetFundamentalsResponse): unknown {
    ...
    if (message.fundamentals?.length) {
      obj.fundamentals = message.fundamentals.map((e) =>
        GetAssetFundamentalsResponse_StatisticResponse.toJSON(e)
      );
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GetAssetFundamentalsResponse>): GetAssetFundamentalsResponse {
    ...
    message.fundamentals =
      object.fundamentals?.map((e) =>
        GetAssetFundamentalsResponse_StatisticResponse.fromPartial(e)
      ) || [];
    return message;
  },
};
...
export const GetAssetFundamentalsResponse_StatisticResponse: MessageFns<GetAssetFundamentalsResponse_StatisticResponse> =
  {
    encode(
...
export const GetAssetReportsResponse: MessageFns<GetAssetReportsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.events.push(
            GetAssetReportsResponse_GetAssetReportsEvent.decode(reader, reader.uint32())
          );
          continue;
        }
      }
  ...
  toJSON(message: GetAssetReportsResponse): unknown {
    ...
    if (message.events?.length) {
      obj.events = message.events.map((e) =>
        GetAssetReportsResponse_GetAssetReportsEvent.toJSON(e)
      );
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GetAssetReportsResponse>): GetAssetReportsResponse {
    const message = createBaseGetAssetReportsResponse();
    message.events =
      object.events?.map((e) => GetAssetReportsResponse_GetAssetReportsEvent.fromPartial(e)) || [];
    return message;
  },
};
...
export const GetConsensusForecastsResponse: MessageFns<GetConsensusForecastsResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.items.push(
            GetConsensusForecastsResponse_ConsensusForecastsItem.decode(reader, reader.uint32())
          );
          continue;
        }
        case 2: {
  ...
  fromPartial(object: DeepPartial<GetConsensusForecastsResponse>): GetConsensusForecastsResponse {
    ...
    message.items =
      object.items?.map((e) =>
        GetConsensusForecastsResponse_ConsensusForecastsItem.fromPartial(e)
      ) || [];
    message.page =
...
export const GetConsensusForecastsResponse_ConsensusForecastsItem: MessageFns<GetConsensusForecastsResponse_ConsensusForecastsItem> =
  {
    encode(
    ...
    fromPartial(
      ...
      message.bestTargetPrice =
        object.bestTargetPrice !== undefined && object.bestTargetPrice !== null
          ? Quotation.fromPartial(object.bestTargetPrice)
          : undefined;
      message.bestTargetLow =
        object.bestTargetLow !== undefined && object.bestTargetLow !== null
          ? Quotation.fromPartial(object.bestTargetLow)
          : undefined;
      message.bestTargetHigh =
        object.bestTargetHigh !== undefined && object.bestTargetHigh !== null
...
export const GetForecastResponse: MessageFns<GetForecastResponse> = {
  ...
  fromPartial(object: DeepPartial<GetForecastResponse>): GetForecastResponse {
    const message = createBaseGetForecastResponse();
    message.targets =
      object.targets?.map((e) => GetForecastResponse_TargetItem.fromPartial(e)) || [];
    message.consensus =
  ...
  fromPartial(object: DeepPartial<GetForecastResponse_TargetItem>): GetForecastResponse_TargetItem {
    ...
    message.currentPrice =
      object.currentPrice !== undefined && object.currentPrice !== null
        ...
        : undefined;
    message.targetPrice =
      object.targetPrice !== undefined && object.targetPrice !== null
        ? Quotation.fromPartial(object.targetPrice)
        : undefined;
    message.priceChange =
      object.priceChange !== undefined && object.priceChange !== null
        ? Quotation.fromPartial(object.priceChange)
        : undefined;
    message.priceChangeRel =
      object.priceChangeRel !== undefined && object.priceChangeRel !== null
...
export const GetForecastResponse_ConsensusItem: MessageFns<GetForecastResponse_ConsensusItem> = {
  ...
  fromPartial(
    object: DeepPartial<GetForecastResponse_ConsensusItem>
    ...
    message.consensus =
      object.consensus !== undefined && object.consensus !== null
        ...
        : undefined;
    message.minTarget =
      object.minTarget !== undefined && object.minTarget !== null
        ? Quotation.fromPartial(object.minTarget)
        : undefined;
    message.maxTarget =
      object.maxTarget !== undefined && object.maxTarget !== null
...
export interface InstrumentsServiceImplementation<CallContextExt = {}> {
  ...
  bondBy(
    ...
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<BondResponse>>;
  /** Получить список облигаций. */
  bonds(
    request: InstrumentsRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<BondsResponse>>;
  /** Получить график выплат купонов по облигации. */
  getBondCoupons(
  ...
  currencyBy(
    request: InstrumentRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<CurrencyResponse>>;
  /** Получить список валют. */
  currencies(
    request: InstrumentsRequest,
    context: CallContext & CallContextExt
  ...
  etfBy(
    request: InstrumentRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<EtfResponse>>;
  /** Получить список инвестиционных фондов. */
  etfs(
    request: InstrumentsRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<EtfsResponse>>;
  /** Получить фьючерс по его идентификатору. */
  futureBy(
    request: InstrumentRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<FutureResponse>>;
  /** Получить список фьючерсов. */
  futures(
    request: InstrumentsRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<FuturesResponse>>;
  /** Получить опцион по его идентификатору. */
  optionBy(
    request: InstrumentRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<OptionResponse>>;
  /**
   * Deprecated Получить списка опционов.
   *
   * @deprecated
  ...
  shareBy(
    request: InstrumentRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<ShareResponse>>;
  /** Получить список акций. */
  shares(
    request: InstrumentsRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<SharesResponse>>;
  /** Получить индикативные инструменты — индексы, товары и другие. */
  indicatives(
  ...
  getAssetBy(
    ...
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<AssetResponse>>;
  /** Получить список активов. Метод работает для всех инструментов, кроме срочных — фьючерсов и опционов. */
  getAssets(
    request: AssetsRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<AssetsResponse>>;
  /** Получить список избранных инструментов. */
  getFavorites(
  ...
  getBrands(
    ...
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<GetBrandsResponse>>;
  /** Получить бренд по его идентификатору. */
  getBrandBy(
    request: GetBrandRequest,
    context: CallContext & CallContextExt
  ): Promise<DeepPartial<Brand>>;
  /** Получить фундаментальные показатели по активу. */
  getAssetFundamentals(
