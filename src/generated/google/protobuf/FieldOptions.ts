...
export interface FieldOptions {
  ...
  '.google.api.fieldBehavior'?: (_google_api_FieldBehavior | keyof typeof _google_api_FieldBehavior)[];
}
...
export interface FieldOptions__Output {
  ...
  '.google.api.fieldBehavior': (keyof typeof _google_api_FieldBehavior)[];
}
